<html>
	...
	<tr width=100% height=100%>
			...
			<?php
				...
				$sql="SELECT `id`, `brand`, `category`, `type`, `dial colour`, `band colour`, `band material`, `case shape`, `display type`, `model number`, `water resistant`, `warranty`, `warranty type`, `image`, `price` FROM `specification` WHERE `category`='Women'";
				$rs=mysql_query($sql);
