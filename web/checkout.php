			...
			<div class="header">
				...
				<div class="top-nav">
					<ul class="memenu skyblue"><li class="active"><a href="index.php">Home</a></li>
						...
						<li class="grid"><a href="typo.php">Blog</a>
						</li>
			...
			<div class="in-check" >
				...
				<ul class="cart-header">
					<div class="close1"> </div>
						<li class="ring-in"><a href="single.php" ><img src="images/c-1.jpg" class="img-responsive" alt=""></a>
						</li>
				...
				<ul class=" cart-header1">
					<div class="close2"> </div>
						<li class="ring-in"><a href="single.php" ><img src="images/c-2.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span class="name">Analog Watches</span></li>
				...
				<ul class="cart-header2">
					<div class="close3"> </div>
						<li class="ring-in"><a href="single.php" ><img src="images/c-3.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span class="name">Analog Watches</span></li>
		...
		<div class="container">
			<div class="footer-top">
				...
				<div class="col-md-6 footer-right">					
					<p>© 2015 Watch Watchers. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
